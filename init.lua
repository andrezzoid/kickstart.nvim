...
-- Ctrl+HJKL navigation is handled by zellij-nav.nvim
...
require('lazy').setup({
  ...
  require 'kickstart.plugins.mini-files', -- file explorer
  require 'kickstart.plugins.treesitter-context', -- sticky scope at top
